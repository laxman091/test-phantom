...
//var clarity_api = 'https://portal.hydrochem.com.au:1337/trend/42697/14928?adrscode=750%20COLLINS%20STR&from=2018-03-15&to=2018-09-15';
...
phantom.create(['--ignore-ssl-errors=true','--load-images=yes','--local-to-remote-url-access=yes', '--ssl-protocol=any']).then(function(ph){
    ...
    _page.content = "Some html"//Set your html here
    //_page.content = content;//Set your html here
    //res.status(200).send(content);
    res.render('index',{'title': 'Clarity API Template','location': content});    // uncomment with proper jade template
    _page.render(file);
